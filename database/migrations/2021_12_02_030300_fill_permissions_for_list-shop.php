...
class FillPermissionsForListShop extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForListShop constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.list-shop',
            'admin.list-shop.index',
            'admin.list-shop.create',
            'admin.list-shop.show',
            'admin.list-shop.edit',
            'admin.list-shop.delete',
        ]);
